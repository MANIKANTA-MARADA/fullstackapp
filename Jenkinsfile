pipeline {
    ...
    environment {
        ...
        TOMCAT_URL = 'http://16.16.154.172:9090/manager/text'
        TOMCAT_USER = 'admin'
        TOMCAT_PASS = 'admin'
    ...
    stages {
        stage('Clone Repository') {
            steps {
                git url: 'https://github.com/MANIKANTA-MARADA/fullstackapp.git', branch: 'main'
            }
        }
    ...
    post {
        success {
            echo "✅ Backend deployed: http://16.16.154.172:9090/springapp1"
            echo "✅ Frontend deployed: http://16.16.154.172:9090/frontapp1"
        }
        failure {
